...
```{r directory}
directory <- '/Users/cervas/Library/CloudStorage/GoogleDrive-jcervas@andrew.cmu.edu/My Drive/GitHub/amberson/Elections/2024/2024-12-15'

unitWeights <- read.csv("https://raw.githubusercontent.com/jcervas/amberson/refs/heads/main/Elections/unit-weights.csv?token=GHSAT0AAAAAAC4KUAW2YVGVENQTVHQYYKZ4Z3JY2HA")

# unitWeights <- read.csv('/Users/cervas/Library/CloudStorage/GoogleDrive-jcervas@andrew.cmu.edu/My Drive/GitHub/amberson/Elections/amberson-emails.csv')
```
...
merge(registration,unitWeights, by="Email")
```
