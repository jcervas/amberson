...
```{r}
paste0(100 * sum(voted$voted)/dim(registration)[1], "%")
```


# Unit Percentage (Weighted) voted"
```{r}
total_vote_weight <- sum(voted_merge$Weight[voted_merge$voted %in% 1])
paste0(round(total_vote_weight/999989, d=3) * 100, "%")
```
